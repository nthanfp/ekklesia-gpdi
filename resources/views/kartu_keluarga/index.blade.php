        ...
        <div class="card-body">
            <form method="GET" class="row g-3 mb-3">
                <div class="col-md-3">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="Cari No KK/Nama"
                ...
                <div class="col-md-3">
                    ...
                    <select name="sort_by" class="form-select">
                        ...
                        <option value="jemaats_count" {{ request('sort_by') == 'jemaats_count' ? 'selected' : '' }}>Jumlah
                            Anggota</option>
                        <option value="tanggal_pernikahan"
                            {{ request('sort_by') == 'tanggal_pernikahan' ? 'selected' : '' }}>Tanggal Pernikahan</option>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <select name="sort_order" class="form-select">
                        <option value="asc" {{ request('sort_order') == 'asc' ? 'selected' : '' }}>A-Z / Terendah
                        </option>
                        <option value="desc" {{ request('sort_order') == 'desc' ? 'selected' : '' }}>Z-A / Tertinggi
                        </option>
                    </select>
                </div>
                    ...
                    <tbody>
                        @forelse($kartuKeluargas as $kk)
                            <tr>
                                ...
                                <td>
                                    @if ($kk->kepalaKeluarga && $kk->kepalaKeluarga->tanggal_pernikahan)
                                        @php
                                            $tanggalPernikahan = \Carbon\Carbon::parse(
                                                $kk->kepalaKeluarga->tanggal_pernikahan,
                                            );
                                        @endphp
                                        <div class="d-flex align-items-center gap-2">
