                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="kecamatan_id" name="kecamatan_id"
                            class="form-select @error('kecamatan_id') is-invalid @enderror" disabled>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="kelurahan_id" name="kelurahan_id"
                            class="form-select @error('kelurahan_id') is-invalid @enderror" disabled>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" name="alamat_rt" id="alamat_rt"
                                ...
                                value="{{ old('alamat_rt') }}" min="1" max="9999">
                            @error('alamat_rt')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat_lengkap" id="alamat_lengkap"
                                class="form-control @error('alamat_lengkap') is-invalid @enderror" rows="2">{{ old('alamat_lengkap') }}</textarea>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function fetchItems(level, parentId, targetSelect) {
